...
class Therapy(DocumentPdf):
    ...
    def create_pages(self):
        ...
        self.set_font("Roboto", size=DOCUMENT_FONT_SIZE - 1)
        self.write(text="zwischen")
        self.ln(DOCUMENT_DEFAULT_OFFSET)

        self.set_font("Roboto", "B", DOCUMENT_HEADER_FONT_SIZE)
        self.write(text="Mervi Fischbach\n")
        self.set_font("Roboto", size=DOCUMENT_FONT_SIZE)
        ...
        for clause in self.clauses:
            ...
            with self.offset_rendering() as dummy:
                ...
                dummy.set_font("Roboto", size=DOCUMENT_FONT_SIZE)
                dummy.multi_cell(0, DOCUMENT_FONT_SIZE / 3, description)
            ...
            self.set_font("Roboto", size=DOCUMENT_FONT_SIZE)
            self.multi_cell(0, DOCUMENT_FONT_SIZE / 3, description)
            self.ln(DOCUMENT_DEFAULT_OFFSET)
